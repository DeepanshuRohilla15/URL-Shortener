    ...
    <div className="flex flex-col items-center">
      ...
      <Accordion type="multiple" collapsible className="w-full md:px-11 ">
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            When you enter a long URL, our system generates a shorter verison of that URL. This shortened URL redirects to the original long URL when accessed.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            You can view the number of clicks, geolocations data of the clicks and device types (mobile/desktops) for each of your shortened URLs.
          </AccordionContent>
        </AccordionItem>
    </Accordion>
    </div>
